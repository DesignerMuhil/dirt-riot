    ...
    <div className='PowerFeatureSection'>
            ...
            <div className='Header'>
                <div className='HeaderText'>
                    ...
                    <p>Crafted with premium components, a powerful drivetrain, and an intelligent digital backbone, it delivers the perfect fusion of muscle and mind. Every ride becomes an expedition — electric, effortless, and explosive.</p>
                </div>

                <button className='ViewBtn'>VIEW PRODUCT</button>
                
            </div>
            <img className='HrzLine'src="./src/assets/HRZ-Line.svg" alt="" />
            ...
            <div className='Arrow'>
                <img src="./src/assets/HRZ-Arrow.svg" alt="Arrow" />
            </div>
