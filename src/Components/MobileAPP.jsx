...
import appImg1 from '../assets/MBLAPP-IMG1.png'
import appImg2 from '../assets/MBLAPP-IMG2.png'
  ...
  return (
    <div className='MobileAppSection'>
        ...
        <div className='headerMobileApp'>
            ...
            <p>
              The dedicated mobile app transforms your Electric Off-Road Bike into a connected beast, giving you total control from your pocket. Seamlessly paired via Bluetooth and compatible with both iOS and Android, the app is your personal command center—built for riders who don’t just ride, but ride smart.
            </p>
        </div>

        <div className='MobileAppImages'>
            <img src={appImg1} alt="Mobile App Screen 1" />
            <img src={appImg2} alt="Mobile App Screen 2" />
        </div>
